 ...
 */
public class GenericRowMapperMap implements RowMapper{

    Logger log = Logger.getLogger(GenericRowMapperMap.class.toString());

    private Class clazz;
    private List<String> indexes;

    public GenericRowMapperMap(Class clazz, String... indexes){
        this.clazz  = clazz;
    ...
    public Map mapRow(ResultSet rs, int rowColumn) throws SQLDataException{
        ...
        try{
            ...
            do{
                ...
                result.put(indexBuilder.toString(), object);
